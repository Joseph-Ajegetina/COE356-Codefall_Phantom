    ...
    return (
        ...
        <div className="sideBarWrapper">
            <div className="sideBarMenu">
                ...
                <ul className="sideBarList">
                    <li className="sideBarListItem">
                       <MailOutlineOutlinedIcon className="sideBarIcon"/> <a href="https://mail.google.com/mail/u/0/#inbox">Mail</a>
                    </li>
                    <li className="sideBarListItem">
                       <FeedbackOutlinedIcon className="sideBarIcon"/> <a href="">FeedBack</a>
                    </li>
                    <li className="sideBarListItem">
                       <ChatBubbleOutlineOutlinedIcon className="sideBarIcon"/> <a href="">Messsages</a>
                    </li>
                </ul>
            </div>
        </div>
