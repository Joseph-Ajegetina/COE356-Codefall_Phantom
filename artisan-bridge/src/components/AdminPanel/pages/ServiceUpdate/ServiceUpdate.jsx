        ...
        <div className="serviceUpdate"> 
            ...
            <div className="artisanContainer">
                    <div className="artisanShow">
                        ...
                        <img src="../images/elipseimage1.png" alt="" className="artisanShowImg"/>
                        ...
                        <div className="leftRight">
                            ...
                            <div className="artisanEditLeft">
                                <div className="artisanEditItem">
                                    ...
                                    <input type="text" placeholder="Electronics" className="artisanUpdateInput"/>
                                </div>
                                <div className="artisanEditItem">
                                    <label htmlFor="">Description</label>
                                    <input type="text" placeholder="Some Text" className="artisanUpdateInput"/>
                                </div>
                            ...
                            <div className="artisanEditUpload">
                                     <img src="../images/elipseimage1.png" alt="" className="artisanEditImg"/>
